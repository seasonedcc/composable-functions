...
type ExpectDF<D extends DomainFunction<V>, V> = Expect<
  DomainFunction<V> extends D ? true : never
>
...
describe('makeDomainFunction', () => {
  describe('when it has no input', async () => {
    ...
    {
      type test = ExpectDF<typeof handler, string>
    }
  ...
  describe('when it has no environment', () => {
    it('uses zod parser to create parse the input and call the domain function', async () => {
      ...
      {
        type test = ExpectDF<typeof handler, number>
      }
  ...
  it('uses zod parsers to parse the input and environment and call the domain function', async () => {
    ...
    {
      type test = ExpectDF<typeof handler, readonly [number, number]>
    }
  ...
  it('returns error when the domain function throws an Error', async () => {
    ...
    {
      type test = ExpectDF<typeof domainFunction, never>
    }
...
describe('all', () => {
  it('should combine two domain functions into one', async () => {
    ...
    const c = all(a, b)
    {
      type test = ExpectDF<typeof c, [number, number]>
    }
  ...
  it('should combine many domain functions into one', async () => {
    ...
    const d = all(a, b, c)
    {
      type test = ExpectDF<typeof d, [string, number, boolean]>
    }
  ...
  it('should return error when one of the domain functions has input errors', async () => {
    ...
    const c = all(a, b)
    {
      type test = ExpectDF<typeof c, [number, string]>
    }
  ...
  it('should return error when one of the domain functions fails', async () => {
    ...
    const c = all(a, b)
    {
      type test = ExpectDF<typeof c, [number, never]>
    }
  ...
  it('should combine the inputError messages of both functions', async () => {
    ...
    const c = all(a, b)
    {
      type test = ExpectDF<typeof c, [string, string]>
    }
  ...
  it('should combine the error messages when both functions fail', async () => {
    ...
    const c = all(a, b)
    {
      type test = ExpectDF<typeof c, [never, never]>
    }
...
describe('first', () => {
  ...
  it('should return error when all of the domain functions fails', async () => {
    ...
    const c = first(a, b)
    {
      type test = ExpectDF<typeof c, string>
    }
...
describe('merge', () => {
  it('should combine two domain functions results into one object', async () => {
    ...
    const c = merge(a, b)
    {
      type test = ExpectDF<typeof c, { resultA: number } & { resultB: number }>
    }
  ...
  it('should return error when one of the domain functions has input errors', async () => {
    ...
    const c = merge(a, b)
    {
      type test = ExpectDF<typeof c, { id: number }>
    }
  ...
  it('should return error when one of the domain functions fails', async () => {
    ...
    const c = merge(a, b)
    {
      type test = ExpectDF<typeof c, never>
    }
  ...
  it('should combine the inputError messages of both functions', async () => {
    ...
    const c = merge(a, b)
    {
      type test = ExpectDF<typeof c, { resultA: string } & { resultB: string }>
    }
  ...
  it('should throw an error when the results of some domain functions are not objects', async () => {
    ...
    const c = merge(a, b)
    {
      type test = ExpectDF<typeof c, number & { resultB: number }>
    }
...
describe('pipe', () => {
  ...
  it('should compose more than 2 functions', async () => {
    ...
    const d = pipe(a, b, c)
    {
      type test = ExpectDF<typeof c, boolean>
    }
...
describe('sequence', () => {
  it('should compose domain functions from left-to-right saving the results sequentially', async () => {
    ...
    {
      type test = ExpectDF<typeof c, [{ id: number }, { result: number }]>
    }
  ...
  it('should use the same environment in all composed functions', async () => {
    ...
    const c = sequence(a, b)
    {
      type test = ExpectDF<typeof c, [{ inp: number }, { result: number }]>
    }
  ...
  it('should fail on the first environment parser failure', async () => {
    ...
    const c = sequence(a, b)
    {
      type test = ExpectDF<typeof c, [{ inp: number }, number]>
    }
  ...
  it('should fail on the second input parser failure', async () => {
    ...
    const c = sequence(a, b)
    {
      type test = ExpectDF<typeof c, [{ inp: string }, number]>
    }
